...
module.exports = {"professions":["Abbot/Abbess","Abjurer","Accountant","Acolyte","Acrobat","Actor","Admiral","Adventurer","Advisor","Alchemist","Animal Handler","Anthropologist","Apothecary","Apprentice","Arborist","Archaeologist","Archbishop","Archduke/Archduchess","Archeologist","Archer","Architect","Archivist","Archmage","Aristocrat","Armorer","Artificer","Artist","Assassin","Astrologer","Augurer","Bailiff","Baker","Bandit","Banker","Barber","Barber/Hairdresser","Barkeep","Barmaid","Baron/Baroness","Bartender","Basketweaver","Beast-Tamer (Circus)","Beekeeper","Beggar","Birdcatcher","Bishop","Blacksmith","Bladesmith","Blood Hunter/Monster Hunter","Bloodletter","Boatman","Bodyguard","Bookbinder","Bosun","Botanist","Bouncer","Bounty Hunter","Bowyer","Brewer","Brickmaker","Brickmason","Brigand","Broom Maker","Brothel Owner","Brothel Worker","Burglar","Butcher","Cabbie/Wagoner","Calligrapher","Candlemaker","Captain","Caravan Guard","Caravaneer","Cardinal","Carpenter","Cartographer","Cartwright (Cart Maker)","Castellan","Cavalier","Chancellor","Chandler (Candle Maker)","Chaplain","Charcoal Maker","Charioteer","Charlatan/Conman","Chef","Chemist","Chief","Chimney Sweeper","City Guard","City Watch","Civic Engineer","Claymason","Clergy","Cleric","Clerk","Cobbler","Cockfighter/Gamefighter","Collector","Composer","Con Artist","Conjuror","Constable","Construction Worker","Cook/Chef","Cooper (Barrel Maker)","Copyist","Councilman / woman","Count/Countess","Courier","Courtier","Cowherd","Crier","Crime Boss","Croupier","Cult Leader","Cultist","Cutler","Cutpurse","Dairyboy/Dairymaid","Dancer","Dean","Deserter","Detective/Investigator","Diplomat","Disgraced Noble","Distiller","Diviner","Dock Worker","Doctor","Drug Lord","Duelist","Duke/Duchess","Dung Carter","Dungeon Delver","Elder/Chief","Elder/Retiree","Elected Official","Elementalist","Embroiderer","Emperor/Empress","Enchanter/Enchantress","Engineer","Engraver","Entrepreneur","Evoker","Ex-Criminal","Executioner","Exile","Explorer","Falconer","Far Traveler","Farm-Hand","Farmer","Fence (criminal)","Ferryman","Fireman","First Mate","Fisher","Fishmonger","Fletcher","Florist","Folk Hero","Fool","Forager","Forester","Friar","Furniture Artisan","Furrier","Gambler","Gamekeeper","Gardener","Gemcutter","Geneologist","General Contractor","General Laborer","General","Gilder","Gladiator","Glassblower","Glasspainter","Glazier/Glassmaker","Glovemaker","Goatherder","Goldsmith/Silversmith","Government Official","Governor","Grain Farmer","Grave Robber/Tomb Raider","Gravedigger","Grocer","Groom","Guard","Guide","Guild Master","Hatter/Milliner","Hawker","Healer","Hearth-witch","Heckler","Helmsman","Herald","Herbalist","Herder","Heretic","Hermit","High Priest/Pope","Historian","Horologist","Horse Trainer","Housemaid","Housewife/Househusband","Hunter","Illuminator","Illusionist","Innkeeper","Inquisitor","Interpreter","Ironmonger","Jailer","Jester","Jeweler","Judge","Kidnapper","King/Queen","Kitchen Drudge","Knight","Laborer","Lamplighter","Landlord","Landscaper","Lantern Lighter","Latrine Digger","Laundry Worker","Lawyer","Lawyer/Advocate","Leatherworker","Librarian","Linguist","Loan Shark","Locksmith","Longshoreman","Mage","Maid/Butler","Man-at-Arms","Marquess","Marshall","Mason","Master of Coin","Master of Horses","Master of Hounds","Master of the Revels","Master of Hounds","Mathematician","Mayor","Mercenary","Mercer","Merchant of Antiques","Merchant of Aphrodisiacs","Merchant of Art","Merchant of Books/Information","Merchant of Clothing","Merchant of Crafting Materials","Merchant of Drugs","Merchant of Food/Spices","Merchant of Furniture","Merchant of General Goods","Merchant of Licenses","Merchant of Medicine/Homeopathic Remedies","Merchant of Pets/Animals","Merchant of Second-Hand Goods","Merchant of Slaves","Merchant of Transportation/Guide","Merchant of Weapons","Merchant","Messenger","Midwife","Military Tactician","Militia","Miller","Miner","Minister","Minstrel","Missionary","Monk","Mortician","Musician","Navigator","Necromancer","Noble","Nun","Nurse","Orator/Spokesman","Orphanage Caretaker","Outlaw","Page","Painter","Paladin","Pardoner","Pastry Chef","Peddler","Performer","Perfumer","Philosopher","Physician","Pickpocket","Pig Farmer","Pilgrim","Piper","Pirate","Plantation Owner","Plasterer","Playwright","Plumer","Poacher","Poet","Politician","Porter","Potter","Priest","Prince/Princess","Printer/Copier","Privycleaner","Professor","Prophet","Prospector","Prostitute","Purser","Quilter","Rag-and-Bone Man (used clothes salesman)","Rancher","Ranger","Rat Catcher","Rebel/Political Dissident","Refugee","Renderer","Ringman (Circus)","Ritualist","Roofer","Rope-maker","Runaway Slave","Runecaster","Saddle Maker","Saddler","Sage","Sailor","Sapper","Scholar/Researcher","Scout","Scribe","Scribe's Assistant","Sculptor","Sea Captain","Seamstress/Tailor","Seer/Oracle","Sentinel","Sergeant","Sergeant-at-Arms","Servant","Sexton","Shaman","Shapeshifter","Sheepshearer","Shepherd","Ship Captain","Shipwright","Shoemaker","Siege Artillerist","Silversmith","Singer/Soprano","Slave Driver","Slave","Smuggler","Soaper","Soldier","Sorcerer/Sorceress","Spearman","Speculator","Spy","Squatter","Squire","Stable-hand","Stable-Master","Steward","Stonecutter","Stonemason","Storyteller","Street Sweeper","Street Vendor","Streetlayer","Student","Summoner","Surgeon/Chirurgeon","Surveyor","Swab","Tactician","Tailor","Tanner","Tattooist","Tavern Worker","Tax collector","Taxidermist","Teacher","Templar","Thatcher","Theologian","Thief/Rogue","Thresher","Thriftdealer","Thug","Tinker","Toll Guard","Torturer","Town Crier","Town Drunk","Toymaker","Tracker","Tradesman","Translator","Transmuter","Trapper","Treasurer","Tumbler","Tutor","Unemployed","Urchin","Vagabond","Vermin Catcher","Veterinarian","Vintner","Viscount/Viscountess","Waitress/Waiter","Wandering Trader","Ward","Warden","Warlock","Warmage","Watchmaker","Water Bearer","Weaponsmith","Weaver","Wheelwright","Whittler","Whore","Witch","Witchdoctor","Wizard","Woodcarver","Woodcutter","Wordsmith","Wrestler/Brawler","Writer","Zookeeper"]};
